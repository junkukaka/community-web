  ...
  methods: {
    ...
    save: function () {
      ...
      if (this.editedIndex > -1) {
        ...
        this.$http.put("/wikiMenu/menus", data).then((response) => {
          this.initialize();
        });
        // this.$router.go(0);
        //Insert function
        ...
        let data = this.editedItem;
        this.$http.post("/wikiMenu/menus", data).then((response) => {
          this.initialize();
        });
    ...
    deleteItemConfirm() {
      ...
      this.$nextTick(function () {
        this.$http.delete("/wikiMenu/menus/" + id).then((response) => {
          this.initialize();
        });
      });
