            ...
            <v-list width="260" style="padding:13px 0">
                <v-list-item    
                    ...
                    <v-list-item-content>
                        ...
                        <v-list-item-title>{{ `${$store.state.user == null ? 'username' : $store.state.user.userName}`}}</v-list-item-title>
                        <v-list-item-subtitle>{{ `${$store.state.user == null ? 'email' : $store.state.user.email}`}}</v-list-item-subtitle>
                    </v-list-item-content>
                    <v-list-item-action>
